...
internal class _CustomersEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("id", "name");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id", "name");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "name");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "name");
    ...
    public function _CustomersEntityMetadata(customers : _Super_Customers)
    {
        ...
        model_internal::_instance = customers;     
    }
