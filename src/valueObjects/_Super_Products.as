...
public class _Super_Products extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
	...
	private var _internal_img_name : String;
	...
	[Bindable(event="propertyChange")] 
    public function get img_name() : String    
    {
            return _internal_img_name;
    }    
    ...
    public function set img_name(value:String) : void 
    {    	
        var recalcValid:Boolean = false;
    	if (value == null || _internal_img_name == null)
    	{
    		recalcValid = true;
    	}	
    	
    	
    	var oldValue:String = _internal_img_name;               
        if (oldValue !== value)
        {
            _internal_img_name = value;
        }    	     
   ...
   model_internal function setterListenerAnyConstraint(value:flash.events.Event):void
   {
    ...
    model_internal function calculateIsValid():Boolean
    {
		...
		if (_model.isImg_nameAvailable && _internal_img_name == null)
		{
			violatedConsts.push("img_nameIsRequired");
			validationFailureMessages.push("img_name is required");
		}
