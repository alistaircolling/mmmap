...
internal class _ProductsEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("id", "name", "img_name");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id", "name", "img_name");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "name", "img_name");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "name", "img_name");
    ...
    public function _ProductsEntityMetadata(products : _Super_Products)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["img_name"] = new Array();
                        
            // collection base map
            model_internal::collectionBaseMap = new Object()
        }                        
        
        model_internal::_instance = products;     
    }
    ...
    public function get isValid() : Boolean
    {
     ...
     [Bindable(event="propertyChange")] 
     public function get isImg_nameAvailable():Boolean
     {
        return true;
     }                       
    ...
    [Bindable(event="propertyChange")]   
    public function get img_nameStyle():com.adobe.fiber.styles.Style
    {
		return model_internal::_nullStyle;		
    }      
